...
func (coord *RootCoordMock) DescribeCollectionWithState(ctx context.Context, req *milvuspb.DescribeCollectionRequest, opts ...grpc.CallOption) (*rootcoordpb.DescribeCollectionResponse, error) {
	resp, err := coord.DescribeCollection(ctx, req, opts...)
	return &rootcoordpb.DescribeCollectionResponse{
		Status:               resp.Status,
		Schema:               resp.Schema,
		CollectionID:         resp.CollectionID,
		VirtualChannelNames:  resp.VirtualChannelNames,
		PhysicalChannelNames: resp.PhysicalChannelNames,
		CreatedTimestamp:     resp.CreatedTimestamp,
		CreatedUtcTimestamp:  resp.CreatedUtcTimestamp,
		ShardsNum:            resp.ShardsNum,
		Aliases:              resp.Aliases,
		StartPositions:       resp.StartPositions,
		ConsistencyLevel:     resp.ConsistencyLevel,
		CollectionName:       resp.CollectionName,
		Properties:           resp.Properties,
		DbName:               resp.DbName,
		NumPartitions:        resp.NumPartitions,
		DbId:                 resp.DbId,
