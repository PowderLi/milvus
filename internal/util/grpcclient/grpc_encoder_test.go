...
func BenchmarkGrpcCompressionStringKlauspost(b *testing.B) {
	benchmarkWithCompressor(b, Klauspost, Data)
}

func BenchmarkGrpcCompressionStringDatadog(b *testing.B) {
	benchmarkWithCompressor(b, Datadog, Data)
}

func stringCopy(data string, times int) string {
	for i := 0; i < times; i++ {
		data += data
	}
	return data
...
func BenchmarkGrpcCompressionString2Klauspost(b *testing.B) {
	benchmarkWithCompressor(b, Klauspost, stringCopy(Data, 2))
}

func BenchmarkGrpcCompressionString2Datadog(b *testing.B) {
	benchmarkWithCompressor(b, Datadog, stringCopy(Data, 2))
}

func BenchmarkGrpcCompressionString4Klauspost(b *testing.B) {
	benchmarkWithCompressor(b, Klauspost, stringCopy(Data, 4))
}

func BenchmarkGrpcCompressionString4Datadog(b *testing.B) {
	benchmarkWithCompressor(b, Datadog, stringCopy(Data, 4))
}

func BenchmarkGrpcCompressionString8Klauspost(b *testing.B) {
	benchmarkWithCompressor(b, Klauspost, stringCopy(Data, 8))
}

func BenchmarkGrpcCompressionString8Datadog(b *testing.B) {
	benchmarkWithCompressor(b, Datadog, stringCopy(Data, 8))
}

func BenchmarkGrpcCompressionString16Klauspost(b *testing.B) {
	benchmarkWithCompressor(b, Klauspost, stringCopy(Data, 16))
}

func BenchmarkGrpcCompressionString16Datadog(b *testing.B) {
	benchmarkWithCompressor(b, Datadog, stringCopy(Data, 16))
}

func BenchmarkGrpcCompressionVectorKlauspost(b *testing.B) {
	benchmarkWithCompressor(b, Klauspost, Vector)
}

func BenchmarkGrpcCompressionVectorDatadog(b *testing.B) {
	benchmarkWithCompressor(b, Datadog, Vector)
}
...
func benchmarkWithCompressor(b *testing.B, compressorName, data string) {
