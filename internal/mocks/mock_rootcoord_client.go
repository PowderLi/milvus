...
//   - in *milvuspb.DescribeCollectionRequest
//   - opts ...grpc.CallOption
func (_e *MockRootCoordClient_Expecter) DescribeCollection(ctx interface{}, in interface{}, opts ...interface{}) *MockRootCoordClient_DescribeCollectionWithState_Call {
	return &MockRootCoordClient_DescribeCollectionWithState_Call{Call: _e.mock.On("DescribeCollection",
		append([]interface{}{ctx, in}, opts...)...)}
}
